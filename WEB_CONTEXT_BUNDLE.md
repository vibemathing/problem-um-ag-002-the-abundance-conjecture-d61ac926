...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ag-002-the-abundance-conjecture-d61ac926-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/AG-002"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ag-002-the-abundance-conjecture-d61ac926-v1",
      "problem_contract_sha256": "3889f3d40332f99368cba8516769a26f7c9ff33fbf4346efc94dd08061c522e5",
      "problem_id": "problem:um-ag-002-the-abundance-conjecture-d61ac926",
      "route_id": "route:um-ag-002-the-abundance-conjecture-d61ac926-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ag-002-the-abundance-conjecture-d61ac926-source-fidelity-01",
      "graph_id": "graph:um-ag-002-the-abundance-conjecture-d61ac926-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ag-002-the-abundance-conjecture-d61ac926-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ag-002-the-abundance-conjecture-d61ac926-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "For a minimal model $X$ of non-negative Kodaira dimension, the canonical divisor $K_X$ is semi-ample."
          },
          "statement_sha256": "aec17e8bf40d271aab7cfacfa2da6af18193a5e6f116bc964e95a19741ba370c"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ag-002-the-abundance-conjecture-d61ac926-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ag-002-the-abundance-conjecture-d61ac926-root",
      "route_id": "route:um-ag-002-the-abundance-conjecture-d61ac926-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "domain": {
      "description": "Source-native Algebraic Geometry problem. Mathematical objects and notation are exactly those explicitly present in the frozen source statement.",
      "objects": [
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ag-002-d09807b64bd4",
        "url": "https://www.unsolvedmath.com/problems/AG-002"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
